...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $product = array_values([
            ...
            'Jam tangan unisex casio Strap Rubber',
            'LEGO Batman',
            'MASKER DUCKBILL FACEMASK PREMIUM 50 PCS',
            'Jamu Cap Kereta Expres Sinatren Original',
            'Soft Case Motif Bunga Kupu-Kupu Ungu Untuk iPhone',
            'TALI GANTUNGAN MOTIF KARAKTER',
            'Tatajoy 2.4Ghz Excavator Remote Control ',
            'SORTING PUZZLE/ ball puzzle / puzzle bola/ puzzle kubus',
            'Yo-Yo',
            'Celana Chinos',
